# neofuuka-scraper-plus-filters

This is a fork of neofuuka-scraper.

**neofuuka-scraper-plus-filters** is a next-generation 4chan scraper, with filters, written in Python.
